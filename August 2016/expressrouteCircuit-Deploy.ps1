...
param (
    ...
    [string] $templateFilePath = "C:\Users\carpat\OneDrive - Microsoft\Azure-PowerShell\August 2016\virtualNetwork-Template.json",
...
if ($createVnetGateway) {
    ...
    # - The subnet address space must be /27 or larger (/26, /25, etc.).0
