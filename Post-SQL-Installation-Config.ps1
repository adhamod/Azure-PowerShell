...
<#
Invoke-Sqlcmd2 is an open-source alternative to Invoke-Sqlcmd
URL: https://github.com/RamblingCookieMonster/PowerShell/blob/master/Invoke-Sqlcmd2.ps1
#>
...
$sqlParams = @{SMTPServerName="$SMTPServerName";
               OperatorEmailAddress="$OperatorEmailAddress"}

Invoke-Sqlcmd2 -ServerInstance $DBServer -Database $database -InputFile $DBScriptFile -SqlParameters $sqlParams
...
# Build the list of parameters names and parameter values to be passed to the TSQL script
$sqlParams = @{TargetDataFilesLocation="$TargetDataFilesLocation";
               TargetDataSizeMB="$TargetDataSizeMB";
               TargetDataFilegrowthMB="$TargetDataFilegrowthMB";
               TargetTlogFilesLocation="$TargetTlogFilesLocation";
               TargetTlogSizeMB="$TargetTlogSizeMB";
               TargetTlogFilegrowthMB="$TargetTlogFilegrowthMB"}
